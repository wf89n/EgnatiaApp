...
const Groups = () => {
  ...
  // Sort groups by total expenses (descending)
  const sortedGroups = groups.sort((a, b) => b.total_expenses - a.total_expenses);
  ...
  // Function to calculate the total cost of all departments
